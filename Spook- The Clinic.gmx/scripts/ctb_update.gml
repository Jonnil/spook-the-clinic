...
var skip = keyboard_check_pressed(vk_enter/*CTB_SkipKey*/)or keyboard_check_pressed(vk_shift)or keyboard_check_pressed(vk_space)or gamepad_button_check_pressed(0,global.face1);
//skipkey=max(vk_enter,vk_shift,vk_space,global.face1);
if( !pause ) {
